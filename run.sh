...
echo "Building..."
# Inject git short hash into generated Swift file
mkdir -p Sources/Generated
GIT_SHORT=$(git rev-parse --short=3 HEAD 2>/dev/null || echo "???")
cat > Sources/Generated/BuildVersion.swift << SWIFT
// Auto-generated by run.sh — do not edit
enum BuildVersion {
    static let commitHash = "$GIT_SHORT"
}
SWIFT
swift build 2>&1
